        ...
        <div class="row">
            ...
            <div class="col-lg-5 p-3">
                <form class="p-4 bg-dark-opaque" method="post" action="https://formspree.io/">
                    ...
                    <button type="submit" class="btn mt-4 btn-block btn-outline-primary p-2"><b>Tiến hành đặt</b></button>
                </form>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row my-5 bg-secondary animate-in-down">
            <div class="p-4 col-md-6 bg-primary">
                <h2 class="mb-1">The Adora</h2> <i class="fa d-inline-block fa-star text-white"></i><i class="fa d-inline-block fa-star mx-1 text-white"></i><i class="fa d-inline-block fa-star text-white"></i>
                <p class="my-4">The ADORA Nguyễn Kiệm có vị trí vô cùng thuận tiện, tọa lạc ngay giao lộ huyết mạch Phạm Văn Đồng tiếp nối các quận huyện trung tâm thành phố. The ADORA Nguyễn Kiệm được thiết kế theo phong cách kiến trúc La Mã với các sảnh đường rộng lớn, được lựa chọn cho những buổi sự kiện trọng đại, từ tiệc cưới, tiệc cá nhân tới các Hội nghị, hội thảo đẳng cấp.</p>
    ...
    <div class="container">
        <div class="row my-5 bg-primary animate-in-down">
            <div class="p-4 col-md-6 align-self-center">
                ...
                <p class="my-3">Mang vẻ nổi bật và lộng lẫy tọa lạc tại cung đường Hoàng Văn Thụ náo nhiệt bậc nhất Sài Gòn. Trung tâm tiệc cưới The ADORA Luxury được xây dựng theo hình dáng của viên kim cương sang trọng. Cả tòa nhà mang phong cách châu Âu với 6 sảnh tiệc rộng lớn cùng sức chứa lên đến 3.500 khách. </p>
            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-4 p-3">
                        <img class="img-fluid d-block w-100 mb-3" src="<c:url value="/assets/restaurant/event_1_dark.jpg"/>">
                    ...
                    <div class="col-md-4 p-3">
                        <img class="img-fluid d-block w-100 mb-3" src="<c:url value="/assets/restaurant/event_2_dark.jpg"/>">
                    ...
                    <div class="col-md-4 p-3">
                        <img class="img-fluid d-block w-100 mb-3" src="<c:url value="/assets/restaurant/event_3_dark.jpg"/>">
